...
use wgpu::{
    util::DeviceExt, BindGroup, BindGroupLayoutDescriptor, PipelineCompilationOptions,
    PipelineLayoutDescriptor, RenderPipeline,
};

use super::Pipeline;
use crate::{
    entity::{Vertex, CUBE_VERTEX, CUBE_VERTEX_INDEX},
    render::wgpu_context::WgpuContext,
};
...
impl CubePipeline {
    ...
    pub fn render(&mut self, context: &WgpuContext, view: &wgpu::TextureView) {
        {
            ...
            let mx_total =
                generate_matrix(context.config.width as f32 / context.config.height as f32);
            let mx_ref: &[f32; 16] = mx_total.as_ref();
            context
                .queue
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor { label: None });
        {
            ...
            rpass.draw_indexed(0..CUBE_VERTEX_INDEX.len() as u32, 0, 0..1);
